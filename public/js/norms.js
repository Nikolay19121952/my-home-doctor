...
var Norms = {
     ...
     *
     * sugar     — гликемия натощак
     * sugar_after — гликемия после еды (ТЗ v3.3, пункт 2)
     *
     * Для диабета границы после еды заданы Доктором (4.5–10.0). Для всех
     * остальных статей в таблице норм их не было, и без них поле «после еды»
     * осталось бы вообще без контроля. Поставлен общепринятый ориентир ВОЗ
     * для нормальной толерантности к глюкозе — до 7.8 ммоль/л. Это моё
     * дополнение, оно требует подтверждения Доктора. */
    FIELDS: ['ad_top', 'ad_bottom', 'pulse', 'spo2', 'sugar', 'sugar_after', 'temp', 'bmi'],
    ...
    AGE_ARTICLES: [
        {
            ...
            spo2: [97, 100], sugar: [3.3, 5.5], sugar_after: [3.3, 7.8], temp: [36.3, 37.2], bmi: [14.0, 18.5]
        },
        {
            id: 'child_6_11', title: 'Дети 6–11 лет', minAge: 6, maxAge: 11,
            ad_top: [100, 125], ad_bottom: [60, 80], pulse: [70, 110],
            spo2: [97, 100], sugar: [3.5, 5.5], sugar_after: [3.3, 7.8], temp: [36.2, 37.0], bmi: [14.5, 21.0]
        },
        {
        ...
        },
        {
            ...
            spo2: [94, 98], sugar: [4.0, 6.5], sugar_after: [3.3, 7.8], temp: [36.0, 36.7], bmi: [20.0, 28.0]
        }
    ],
    ...
    DIAGNOSIS_ARTICLES: [
        {
            ...
            spo2: [95, 100], sugar: [3.3, 5.5], sugar_after: [3.3, 7.8], temp: [36.2, 36.9], bmi: [18.5, 27.0],
        ...
        },
        {
            ...
            spo2: [94, 100], sugar: [4.0, 6.5], sugar_after: [3.3, 7.8], temp: [36.0, 36.8], bmi: [20.0, 28.0],
        ...
        },
        {
            ...
            spo2: [97, 100], sugar: [4.5, 8.5], sugar_after: [4.5, 10.0],
        ...
        },
        {
            ...
            spo2: [95, 100], sugar: [4.5, 8.5], sugar_after: [4.5, 10.0],
        ...
        },
        {
            ...
            spo2: [90, 96], sugar: [3.3, 5.5], sugar_after: [3.3, 7.8], temp: [36.2, 36.9], bmi: [18.5, 25.0],
        ...
        },
        {
            ...
            spo2: [95, 100], sugar: [3.3, 5.5], sugar_after: [3.3, 7.8], temp: [35.5, 36.5], bmi: [20.0, 28.0],
        ...
        },
        {
            ...
            ad_top: [130, 150], ad_bottom: [80, 100], pulse: [60, 90],
            spo2: [95, 100], sugar: [4.0, 6.5], sugar_after: [3.3, 7.8], temp: [36.2, 36.9], bmi: [18.5, 25.0],
        ...
        },
        {
            ...
            spo2: [95, 100], sugar: [3.5, 8.0], sugar_after: [3.3, 7.8], temp: [36.3, 37.0], bmi: null,
    ...
    KEYWORDS: [
        ...
        { id: 'hypotension', words: ['гипотензи', 'гипотони', 'низкое давление'] },
    ...
    ALARMS: [
        ...
        {
            field: 'sugar', label: 'Гликемия натощак', above: 13.0,
    ...
    STEP: {
        ...
        pulse: 15,       // уд./мин
        spo2: 3,         // %
        sugar: 1.5,      // ммоль/л, натощак
        sugar_after: 1.5, // ммоль/л, после еды
        temp: 0.5,       // °C
        bmi: 3.0
    },
    ...
    /* Печатает 5 вместо 5.0, а 36.5 оставляет как есть.
       Округление до десятых убирает хвосты вида 9.899999999999999,
       которые появляются при сложении дробных значений. */
    num: function (v) {
        var n = Number(v);
