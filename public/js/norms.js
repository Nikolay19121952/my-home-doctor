...
var Norms = {
     ...
     * sugar_after — гликемия через 2 часа после еды
     *
     * Целевые уровни гликемии для всех статей взяты из «Клинического
     * справочника целевых уровней гликемии» (ВОЗ), переданного Доктором
     * 21.08.2026. Там, где справочник задаёт только верхнюю границу
     * («< 7.8»), нижняя взята равной границе натощак: гипогликемия после
     * еды остаётся гипогликемией. */
    FIELDS: ['ad_top', 'ad_bottom', 'pulse', 'spo2', 'sugar', 'sugar_after', 'temp', 'bmi'],

    /* Общее примечание, обязательное по разделу 4 ТЗ */
    /* Источники, на которых построена таблица (для справочника) */
    SOURCES: [
        'Всемирная организация здравоохранения (ВОЗ)',
        'Клинический справочник целевых уровней гликемии (ВОЗ), 2026',
        'Клинические рекомендации Минздрава РФ',
        'Техническое задание Доктора, редакции v3.1–v3.4'
    ],
    ...
    STEP: {
        ...
        pulse: 15,       // уд./мин
        spo2: 3,         // %
        sugar: 1.0,      // ммоль/л, натощак (уточнено в ТЗ v3.4)
        sugar_after: 1.0, // ммоль/л, после еды
        temp: 0.5,       // °C
        bmi: 3.0
    },
