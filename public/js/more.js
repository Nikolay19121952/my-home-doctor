var More = {
    ...
    renderAbout: function (container) {
        ...
        html += '<div class="about-section">' +
            ...
            '<p class="about-version">Версия 3.0 · июль 2026</p>' +
            '</div>';
        ...
        html += '<div class="about-card">' +
            ...
            '<li><strong>Версия:</strong> 3.0</li>' +
        ...
        html += '<div class="about-card">' +
            ...
            '<ul class="about-facts">' +
            '<li><strong>v3.0</strong> — июль 2026, текущая версия</li>' +
            '<li><strong>v3.1</strong> — облачная синхронизация без ручного переноса файлов, ' +
            'интерактивные графики и сравнение нескольких показателей</li>' +
            '<li><strong>v3.2</strong> — мобильное приложение или расширение возможностей</li>' +
            '</ul>' +
