var More = {
    ...
    renderAbout: function (container) {
        ...
        html += '<div class="about-section">' +
            ...
            '<p class="about-version">Версия 2.2 · июль 2026</p>' +
            '</div>';

        // ТЕКУЩАЯ ВЕРСИЯ (ТЗ v2.2, раздел 4.2)
        html += '<div class="about-card">' +
            '<h3>📌 Текущая версия</h3>' +
            '<ul class="about-facts">' +
            '<li><strong>Версия:</strong> 2.2</li>' +
            '<li><strong>Дата выпуска:</strong> июль 2026</li>' +
        ...
        html += '<div class="about-card">' +
            ...
            '<li>Эта страница с историей разработки</li></ul></div>' +
        ...
        html += '<div class="about-card">' +
            ...
            '<ul class="about-facts">' +
            '<li><strong>v2.2</strong> — июль 2026, текущая версия</li>' +
            '<li><strong>v3.0</strong> — облачная синхронизация без ручного переноса файлов, ' +
            'графики и анализ динамики показателей</li>' +
            '<li><strong>v3.1</strong> — мобильное приложение или расширение возможностей</li>' +
            '</ul>' +
