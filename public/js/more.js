var More = {
    ...
    renderAbout: function (container) {
        ...
        html += '<div class="about-card">' +
            ...
            '«🩺 Отправить доктору» (отправка пакета измерений на анализ) и «💾 Файл» (скачать выбранные записи в формате PDF в папку Downloads (Загрузки)).</div></div>' +
            '<div class="about-step"><span class="about-step-icon">🩺</span>' +
            ...
            'Каждый ответ доктора имеет кнопки: 🖨️ Печать и 💾 Файл (скачать в формате PDF в папку Downloads (Загрузки)).</div></div>' +
            '<div class="about-step"><span class="about-step-icon">📄</span>' +
