...
var SYSTEM_PROMPT = [
    ...
    '',
    'ДЛИННЫЕ ОТВЕТЫ:',
    'Если ответ получается очень длинным (подробная расшифровка анализов, полное медицинское заключение с таблицами), раздели его на части.',
    'В конце каждой части напиши: «Продолжение следует... Напишите «Продолжай» для получения следующей части.»',
    'Каждая часть должна быть логически завершённой (например, одно исследование = одна часть).'
].join('\n');
